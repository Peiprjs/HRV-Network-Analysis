...
```{r}
# Install packages only if not already done
...
```{r}
# Load the lung cancer dataset from an Excel file :3
...
RCy3::mapTableColumn("Ensembl", "Human", "Ensembl", "Entrez Gene", force.single = TRUE)
